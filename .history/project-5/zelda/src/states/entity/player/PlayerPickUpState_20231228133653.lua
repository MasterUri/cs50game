...
function PlayerPickUpState:collides(target)
    return not (self.playerPickbox.pickboxX + self.playerPickbox.pickboxWidth < target.x or self.playerPickbox.pickboxX > target.x + target.width or
                self.playerPickbox.pickboxY + self.playerPickbox.pickboxHeight < target.y or self.playerPickbox.pickboxY > target.y + target.height)
end
