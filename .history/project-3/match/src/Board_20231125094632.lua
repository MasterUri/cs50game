...
function Board:initializeTiles()
    ...
    for n = 1, 8 do
        table.insert(self.tileColor[n], math.random(18))
    end
    ...
    for tileY = 1, 8 do
        ...
        for tileX = 1, 8 do
            ...
            table.insert(self.tiles[tileY], Tile(tileX, tileY, self.tileColor[math.random(8)], math.min(math.random(self.level), math.random(6))))
        end
    end
