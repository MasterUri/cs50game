...
function Board:initializeTiles()
    ...
    for tileY = 1, 8 do
        ...
        for tileX = 1, 8 do
            ...
            table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), math.min(math.random(self.level), math.random(6))))
        end
    end
...
function Board:checkPotentialMatches()
    ...
    if potentialMatches < 1 then
        ...
        for y = 1, 8 do
            for x = 1, 8 do
                if self.tiles[y][x].shiny then
                    table.insert(self.shinyTemp, self.tiles[y][x])
                    --[[
        ...
        --[[
        self.shinyTemp[1] = shinyY
        self.shinyTemp[2] = shinyX
        ]]
        self:initializeTiles()
    end
end
...
function Board:calculateMatches()
    ...
    -- store coordinates of shiny tiles for later
    ...
    for x = 1, 8 do
        for y = 8, 1, -1 do
            ...
            if not tile then
                ...
                local tile = Tile(x, y, math.random(18), math.min(math.random(self.level), math.random(6)))
                tile.y = -32
                self.tiles[y][x] = tile
