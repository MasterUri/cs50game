...
function PlayState:render()
    ...
    love.graphics.setFont(gFonts['medium'])
    love.graphics.setColor(0, 0, 0, 1)
    love.graphics.print("Level: ", 320, 5)
    love.graphics.setColor(1, 1, 1, 1)
    love.graphics.print("Level: ", 304, 4)

    love.graphics.setFont(gFonts['medium'])
    love.graphics.setColor(0, 0, 0, 1)
    love.graphics.print(tostring(self.levelNumber), 20, 5)
    love.graphics.setColor(1, 1, 1, 1)
    love.graphics.print(tostring(self.levelNumber), 19, 4)
