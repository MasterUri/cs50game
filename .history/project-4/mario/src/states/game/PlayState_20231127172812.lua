...
function PlayState:render()
    ...
    love.graphics.setFont(gFonts['medium'])
    love.graphics.setColor(0, 0, 0, 1)
    love.graphics.print(tostring(self.levelNumber), VIRTUAL_WIDTH - (VIRTUAL_WIDTH / 4) + 20, 5)
    love.graphics.setColor(1, 1, 1, 1)
    love.graphics.print(tostring(self.levelNumber), VIRTUAL_WIDTH - (VIRTUAL_WIDTH / 4) + 19, 4)
