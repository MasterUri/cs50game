...
gTextures = {
    ...
    ['lock'] = love.graphics.newImage('graphics/keys_and_locks.png'),
...
gFrames = {
    ...
    ['key'] = GenerateQuadsKeys(gTextures['keys-and-locks']),
    ['lock'] = GenerateQuadsLocks(gTextures['keys-and-locks']),
    ['flagpoles'] = GenerateQuadsFlagPoles(gTextures['flags']),
