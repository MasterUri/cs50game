...
function GenerateQuadsKeys(atlas)
    ...
    for i = 0, 3 do
        quads[i] = love.graphics.newQuad(x + (i * 16), y, 16, 16, atlas:getDimensions())
    end
    return quads
end
...
function GenerateQuadsFlagPoles(atlas)
    ...
    for i = 0, 5 do
        quads[i] = love.graphics.newQuad(x + (i * 16), y, 16, 48, atlas:getDimensions())
    end
...
function GenerateQuadsFlags(atlas)
    ...
    for i = 0, 3 do
        quads[i] = love.graphics.newQuad(x, y + (i * 16), 16, 16, atlas:getDimensions())
    end
