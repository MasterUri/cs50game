...
local GRAVITY = 10 --changed from 20 to 10 because the bird was falling way too fast on my computer
...
function Bird:update(dt)
    ...
    if love.keyboard.wasPressed('space') or love.mouse.wasPressed(1) then
        self.dy = -1.7 --changed from -5 to -1.7 because the bird jumped beyond the screen on my computer
        sounds['jump']:play()
    end
