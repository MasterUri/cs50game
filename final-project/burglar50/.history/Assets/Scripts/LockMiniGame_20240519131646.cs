...
public class LockMiniGame : MonoBehaviour
{
    ...
    public AudioClip unlockSmall;
    public AudioClip unlockBig;
            ...
            if (doorLock.locked) {
                ...
                if (!safe){
                    if (Input.GetKeyDown(KeyCode.UpArrow) || Input.GetKeyDown(KeyCode.W)) {
                        ...
                        if (codeEntered == passcode[lockStep]){
                            ...
                            PlaySound(unlockSmall);
                            if (lockStep == 3) { doorLock.locked = false; PlaySound(unlockBig); }
                        }
                    }
                ...
                // safe lock
                    ...
                    if (Input.GetKeyDown(KeyCode.RightArrow) || Input.GetKeyDown(KeyCode.D)) {
                        ...
                        if (lockStep == 2 && codeEntered == passcode[lockStep]) {
